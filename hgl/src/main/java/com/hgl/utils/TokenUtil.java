...
public class TokenUtil {
    ...
    public static String sign(String uid, String sid, String yb_uid) {
        try {
            //过期时间
            ...
            String t = new Date().getTime() + "";// 时间更新token
            //携带username,ID信息，生成签名
            return JWT.create()
                    .withHeader(header)
                    .withClaim("uid", uid)
                    .withClaim("sid", sid)
                    .withClaim("yb_uid", yb_uid)
                    .withClaim("t", t)
                    .withExpiresAt(date)
                    .sign(algorithm);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        String password = "123";
        String token = sign(username,password, "123");
